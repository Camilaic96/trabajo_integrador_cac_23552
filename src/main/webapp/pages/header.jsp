<header class="header"> 
	<nav class="navbar navbar-expand-lg navbar-dark">
		<div class="container-fluid justify-content-between">
			<a href="${process.cwd()}/../integrador/index.jsp" class="col-8 col-md-6 col-lg-4 col-xl-3 d-flex align-items-center">
				<img src="${process.cwd()}/../integrador/assets/img/logo_cac.png" alt="Logo de Codo a Codo 4.0" class="imgLogo" loading="lazy" />
