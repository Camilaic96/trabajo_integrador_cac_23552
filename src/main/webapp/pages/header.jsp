    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid justify-content-between">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                ...
                aria-label="Toggle navigation" class="col-4">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 w-100 justify-content-end flex-wrap align-items-center">
                    <li class="nav-item">
                        <a class="nav-link active p-3 fs-3" aria-current="page"
                            href="<%=request.getContextPath()%>/../integrador/index.jsp#conference">La conferencia</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link p-3 fs-3"
                            href="<%=request.getContextPath()%>/../integrador/index.jsp#oradores">Los oradores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link p-3 fs-3"
                            href="<%=request.getContextPath()%>/../integrador/index.jsp#placeAndDate">El lugar y la
                            fecha</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link p-3 fs-3"
                    ...
                    <li class="nav-item">
                        <a class="nav-link colorGreen p-3 fs-3"
                            href="<%=request.getContextPath()%>/../integrador/pages/comprar-tickets.jsp">Comprar
                            tickets</a>
                    </li>
                    <li class="nav-item">
