          ...
          <section class="container mt-5" id="form-orador">
		        <div class="row justify-content-center">
		            <div class="col-lg-8 col-xl-7">
		                ...
		                <form action="<%=request.getContextPath()%>/UpdateOradorController" method="POST" class="form-orador__form">
		                    <div class="row gx-2">
		                    ...
		                    <div class="row">
		                        <div class="col mb-3">
		                            ...
		                            <div class="d-flex justify-content-between gap-3">
		                                <button type="submit" class="btn btn-form btn-success w-100 p-3 fs-3">Modificar</button>
										<button class="btn btn-danger w-100 p-3 fs-3" type="button" onclick="btnVolver()">Cancelar</button>
		                            </div>
		                        </div>
		                    </div>
		                </form>
